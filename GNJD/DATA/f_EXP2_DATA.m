function [GNJD_Ten, NOJoB_Ten, GOJD_Ten, JNJD_Ten, P, sv_A, info] = f_EXP2_DATA(N,R,K,snr)
%--------------------------------------------------------------------------
% This function synthesize the noisy data for Experiment 2 in the reference
% below.  
%--------------------------------------------------------------------------
%**************************************************************************
%% inputs:
    ...
    for r2 = r1:R
        for m=1:K
            if r1 ~= r2
                ...
                Noise_ = randn(N) + 1i*randn(N); Noise_ = Noise_/norm(Noise_,'fro');
                GNJD_Ten(:,(m-1)*N+1:m*N,r1,r2) = Ps*GNJD_Ten(:,(m-1)*N+1:m*N,r1,r2)+Pn*Noise_; 
